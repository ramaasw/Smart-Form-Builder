...
export const FormPreview = ({ fields, formData, setFormData }) => {
        ...
        {fields.map((field, index) =>
          evaluateCondition(field, formData) ? (
            ...
            >
              ...
              {field.type === "checkbox" && ( //todo: move below input renderer to separate component
                <input
                  id=""
                  type="checkbox"
                  className="w-4 h-4"
                ...
                <div className="flex flex-1 flex-col ">
                  ...
                  {field.minChar && (
                    <p className="text-xs text-red-400">
                      minimun characters allowed are {field.minChar}{" "}
                    </p>
                  )}
                  {field.maxChar && (
                    <p className="text-xs text-red-400">
                      maximum characters allowed are {field.maxChar}
                    </p>
                  )}
                </div>
              )}
