...
export const DropFields = React.memo(
  ({ fields, ondrop, onselect, fieldReordering, onDelete }) => {
    ...
    const codeExport = () => {
      const generatedCode = generateReactForm();
      // Download as file
      ...
      const formConfig = new Blob(
        [
          `export const formConfig = { title: "Generated Form", fields: [${fieldsStr}] }`,
        ],
        { type: "text/javascript" }
      );
      const formConfigLink = document.createElement("a");
      formConfigLink.href = URL.createObjectURL(formConfig);
      formConfigLink.download = "formConfig.js";
      formConfigLink.click();
    };
